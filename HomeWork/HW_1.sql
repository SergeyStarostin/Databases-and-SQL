...
DROP TABLE IF EXISTS itresume7776435.mobile_phones;
CREATE TABLE itresume7776435.mobile_phones(
    Id SERIAL PRIMARY KEY,
    product_name VARCHAR(45) NOT NULL,
    manufacturer VARCHAR(45) NOT NULL,
    product_count INT,
    price INT NULL);
INSERT INTO itresume7776435.mobile_phones(product_name, manufacturer, product_count, price)
VALUES 
  ('iPhone X', 'Apple', 3, 76000),
  ('iPhone 8', 'Apple', 2, 51000),
  ('Galaxy S9', 'Samsung', 2, 56000),
  ...
  ('P20 Pro', 'Huawei', 5, 36000);
SELECT * 
FROM itresume7776435.mobile_phones;
